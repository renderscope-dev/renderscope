...
> = {
  blue: {
    ...
    caption: "text-blue-700 dark:text-blue-400/60",
  },
  green: {
    bg: "bg-green-500/5",
    ...
    caption: "text-green-700 dark:text-green-400/60",
  },
  purple: {
    bg: "bg-purple-500/5",
    ...
    caption: "text-purple-700 dark:text-purple-400/60",
  },
  pink: {
    bg: "bg-pink-500/5",
    ...
    caption: "text-pink-700 dark:text-pink-400/60",
  },
  orange: {
    bg: "bg-orange-500/5",
    ...
    caption: "text-orange-700 dark:text-orange-400/60",
  },
  rose: {
    bg: "bg-rose-500/5",
    ...
    caption: "text-rose-700 dark:text-rose-400/60",
  },
  cyan: {
    bg: "bg-cyan-500/5",
    ...
    caption: "text-cyan-700 dark:text-cyan-400/60",
  },
};
